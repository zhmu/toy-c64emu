...
bool
CIA::PokeCIA(Memory::addr_t addr, uint8_t val)
{
	ByteAt(addr) = val;
...
bool
CIA::PeekCIA(Memory::addr_t addr, uint8_t& val)
{
	switch(addr & 0xff) {
