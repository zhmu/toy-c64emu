...
uint8_t
CPU6502::GetZeroPageX() /* zero page indexed with x: zp,x */
{
	return m_memory.ReadByte((ReadByteAtPC() + m_x) & 0xff);
}

uint8_t
CPU6502::GetZeroPageY() /* zero page indexed with x: zp,y */
{
	return m_memory.ReadByte((ReadByteAtPC() + m_y) & 0xff);
}

uint8_t
CPU6502::GetAbsolute() /* absolute: a */
{
	return m_memory.ReadByte(ReadWordAtPC());
}

uint8_t
CPU6502::GetAbsoluteX(int& iCycles) /* absolute indexed with x: a,x */
{
...
uint8_t
CPU6502::GetAbsoluteY(int& iCycles) /* absolute indexed with y: a,y */
{
	(void)iCycles; /* TODO What is a page boundary? */
...
uint8_t
CPU6502::GetIndirectX() /* indexed indirect: (zp,x) */
{
...
uint8_t
CPU6502::GetIndirectY(int& iCycles) /* indirect indexed: (zp),y */
{
	(void)iCycles; /* TODO What is a page boundary? */
...
void
CPU6502::DoCompare(uint8_t src, uint8_t imm)
{
...
void
CPU6502::DoBranch(bool take, int& iCycles)
{
