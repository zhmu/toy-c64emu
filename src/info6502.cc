...
Info6502::Info6502(CPU6502& oCPU)
	: m_cpu(oCPU)
{
...
int
Info6502::GetCyclesForOpcode(uint8_t opcode) const
{
	return m_opcode[opcode].GetCycles();
}

void
Info6502::Disassemble(char* output) const
{
	Disassemble(output, m_cpu.m_pc);
}

int
Info6502::Disassemble(char* output, uint16_t addr) const
{
